...
// Netlify Function: receive a B2B corporate-events inquiry from the
// corporate.html modal, HMAC-verify, and forward to the Trigger.dev
// `corporate-lead` task (writes to the B2B Deals Monday board, NOT the
// consumer lead-intake pipeline). Same raw-body HMAC contract as submit-lead.

const TRIGGER_API = "https://api.trigger.dev/api/v1/tasks/corporate-lead/trigger";
